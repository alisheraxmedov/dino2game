...
class MainMenuOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      // Landscape phones are short: the panel scrolls rather than overflowing
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    // The runner is picked here, before the run — the label shows
                    // whichever character is currently saved
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(16.0),
                              border: Border.all(
                                color: GameConstants.neonPurple.withAlpha(80),
                                width: 1.2,
                              ),
                            ),
                            child: Row(
                              ...
                              children: [
                                const Icon(
                                  ...
                                  size: 16.0,
                                  color: GameConstants.neonPurple,
                                ),
                                const SizedBox(width: 8.0),
                                Text(
                                  'SETTINGS  •  ${character.label}',
                                  style: const TextStyle(
                                    fontSize: 12.0,
